...
class IOSUiSettings extends PlatformUiSettings {
  ...
  final Color? doneButtonTitleColor;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'ios.done_button_title_color': this.doneButtonTitleColor?.value,
        'ios.cancel_button_title_color': this.cancelButtonTitleColor?.value,
      };
}
